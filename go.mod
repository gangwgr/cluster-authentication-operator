...
require (
	...
	github.com/openshift/library-go v0.0.0-20260612120359-f29ecf7624f5
...
replace github.com/openshift/library-go => github.com/gangwgr/library-go v0.0.0-20260616091659-18788f9edf41
